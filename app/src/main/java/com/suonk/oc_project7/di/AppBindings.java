...
import com.suonk.oc_project7.repositories.notification.NotificationRepositoryImpl;
...
public abstract class AppBindings {
    ...
    @Binds
    @Singleton
    abstract ChatsRepository bindChatsRepository(ChatsRepositoryImpl impl);
}
